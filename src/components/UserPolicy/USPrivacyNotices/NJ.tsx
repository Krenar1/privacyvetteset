...
const NJ: React.FC<PrivacyPolicySectionProps> = ({ primaryColor, accentColor }) => {
  ...
  return (
    <div className="px-2">
      <div>
        ...
        <p className="text-lg">
          We "sell" certain personal data to third parties, as that term is defined in the NJDPA, including Personal Identifiers, Internet Activity, Commercial Information, Financial Information, and Location Information.
        </p>
        <p className="text-lg">
        ...
        <h3 className="text-[24px] mt-4 mb-2">NJDPA Rights</h3>
        <p className="text-lg">
          Your NJDPA rights are described below.{" "}
          <Link
        ...
        <p className="text-lg">
          ...
          <a
            href="https://www.njoag.gov/contact/file-a-complaint/"
            target="_blank"
            rel="nofollow"
            style={{ color: primaryColor, textDecoration: "underline" }}
          >
