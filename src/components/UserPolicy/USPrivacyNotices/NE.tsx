...
const NE: React.FC<PrivacyPolicySectionProps> = ({ primaryColor, accentColor }) => {
  ...
  return (
    <div className="px-2">
      <div>
        ...
        <p className="text-lg">
          We "sell" certain personal data to third parties, as that term is defined in the NDPA, including Personal Identifiers, Internet Activity, Commercial Information, Financial Information, and Location Information.
        </p>
        <p className="text-lg">
        ...
        <h3 className="text-[24px] mt-4 mb-2">NDPA Rights</h3>
        <p className="text-lg">
          Your NDPA rights are described below.{" "}
          <Link
        ...
        <p className="text-lg">
          You have the right to request that we delete any personal data provided by or obtained about you. We will permanently delete such personal data from our records and direct our processors to do so. However, we may retain your personal data if it is necessary for certain purposes, as allowed by law.
        </p>
        <p className="text-lg">
        ...
        <p className="text-lg">
          ...
          <Link
            to="https://ago.nebraska.gov/constituent-complaint-form"
            target="_blank"
            style={{ color: primaryColor, textDecoration: "underline" }}
          >
