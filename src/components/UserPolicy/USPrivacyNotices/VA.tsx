...
const VA: React.FC<PrivacyPolicySectionProps> = ({ primaryColor, accentColor }) => {
  ...
  return (
    <div className="px-2">
      <div>
        ...
        <p className="text-lg">
          We do not receive monetary consideration in exchange for your data and therefore do not "sell" your data as defined in the VCDPA.
        </p>
        ...
        <h3 className="text-[24px] mt-4 mb-2">VCDPA Rights</h3>
        <p className="text-lg">
        ...
        <p className="text-lg">
          You have the right to request that we delete any personal data provided by or obtained about you. Subject to certain limitations, we will permanently delete any such personal data from our records and direct our processors to do so.
        </p>
        ...
        <p className="text-lg">
          ...
          <Link
            to="https://www.oag.state.va.us/consumer-protection/index.php/file-a-complaint"
            target="_blank"
            style={{ color: primaryColor, textDecoration: "underline" }}
          >
