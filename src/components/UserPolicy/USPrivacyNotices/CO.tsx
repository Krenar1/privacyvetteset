...
const CO: React.FC<PrivacyPolicySectionProps> = ({ primaryColor, accentColor }) => {
  ...
  return (
    <div className="px-2">
      <div>
        ...
        <p className="text-lg">
          We "sell" certain personal data to third parties, as that term is defined in the CPA, including Personal Identifiers, Internet Activity, Commercial Information, Financial Information, and Location Information.
        </p>
        <p className="text-lg">
        ...
        <h3 className="text-[24px] mt-4 mb-2">CPA Rights</h3>
        <p className="text-lg">
          Your CPA rights are described below.{" "}
          <Link
        ...
        <p className="text-lg">
          Once we receive your request, we will verify the information you provided by matching the information that we have collected. If we cannot authenticate your request, we may ask for additional information or deny your request.
        </p>
        ...
        <p className="text-lg">
          ...
          <Link
            to="https://coag.gov/file-complaint/"
            target="_blank"
            style={{ color: primaryColor, textDecoration: "underline" }}
          >
